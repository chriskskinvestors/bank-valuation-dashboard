...
def _render_price_panel(ticker: str):
    ...
    with st.container(key="ov_price_box"):
        st.markdown(
            ...
            "{min-height:0!important;height:1.125rem!important;padding:0 5px!important;"
...
_METRIC_DESC = {
    ...
    "ptbv_discount": "Upside to fair value = (fair price − price) ÷ price. Positive = room to rise; −100% is the floor.",
