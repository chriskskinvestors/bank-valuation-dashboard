...
# The shared engine + backend flag (data/db) — this module used to carry its
# own DATABASE_URL copy, which would have silently fallen back to SQLite once
# the deploy stopped setting that variable (password moved to Secret Manager).
